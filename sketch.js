...
var engine, world;
var ground,ground1,shelf1,shelf2;
var box = [];
var ball,slingShot;
var score = 0;
var timer = 5000;
...
function setup(){
    ...
    ground = new Ground(250,500,2300,30);
    ground1 = new Ground(700,250,120,5);
    ...
    box34 = new Box(700,240,30,30);
    box35 = new Box(685,240,30,30);
    box36 = new  Box(715,240,30,30); 
    box37 = new Box(692,230,30,30);
    box38 = new Box(707,230,30,30);
    box39 = new Box(700,220,30,30);
...
function draw(){
    ...
    text("Press space  to attach the ball back on the Sling ",10,460);
    text("GET 400 POINTS TO WIN!!       ",120,27);
    push();
    ...
    //Winning Conditions
    if(timer > 0 && score>400 && gameState === "Play"){
        gameState = "Win";
    }
    if(timer === 0 && score>400 && gameState === "Play"){
        gameState = "Win";
...
function End(){
   // textSize(20);
    ...
    World.remove(world, box34.body);
    World.remove(world, box35.body);
    World.remove(world, box36.body);
    World.remove(world, box37.body);
    World.remove(world, box38.body);
    World.remove(world, box39.body);
}